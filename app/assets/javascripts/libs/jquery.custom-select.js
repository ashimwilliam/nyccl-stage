...
(function($) {
    var CustomSelect = function(el, opts) {
        ...
        $wrap
            ...
            .html('<span class="' + cls + '" id="cs_' + id + '" aria-controls="' + id + '"><span class="' + innerCls + '"></span><i class="ico-down"></i></span>');
        ...
        function setText() {
            ...
            var w = $inner.parent().is(':visible') ? $inner.parent().outerWidth() : $inner.parent().width();
            $el.width(w);
            $wrap.width(w);
        }
    };
